...
class  SolParser : public antlr4::Parser {
public:
  enum {
    T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, 
    T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11, T__11 = 12, T__12 = 13, T__13 = 14, 
    IDENT = 15, INT = 16, LF = 17, BLOCK_COMMENT = 18, LINE_COMMENT = 19, 
    WS = 20
  };

  enum {
    RuleProgram = 0, RuleProcedure = 1, RuleArgs = 2, RuleArg = 3, RuleReturnStatement = 4, 
    RuleExpression = 5
  };

  explicit SolParser(antlr4::TokenStream *input);

  SolParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  class  BinopExprContext : public ExpressionContext {
  public:
    BinopExprContext(ExpressionContext *ctx);
